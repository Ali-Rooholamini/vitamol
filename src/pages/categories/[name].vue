  ...
  <div class="category-page">
    ...
    <BaseModal v-if="productData" size="lg" modalName="baseModal">
      <div class="body-content">
        <p>
          آبرسان قوی حاوی ویتامین E تثبیت کننده رنگ مو حاوی عصاره طبیعی امگا6 و
          امگا 9 ایجاد سهولت در نرمی و شانه پذیری موها ترمیم کننده و نرم کننده
          موهای آسیب دیده دارای عصاره طبیعی و فرا سودمند روغن ویتال ماسک موی
          حاوی روغن آرگان با خاصیت ضد مو خوره ماسک موی حاوی کراتین با خاصیت رفع
          خشکی و شکنندگی موها ماسک مو خاویار با خاصیت آبرسانی ، نرم کنندگی و
          تثبیت کننده رنگ مو ماسک موی حاوی روغن ماکادمیا دارای عملکرد سه گانه
          تقویت ریشه ، ساقه و پیاز مو حجم محصول : 1000ml - 500ml تنوع محصول :
          کراتین
        </p>
